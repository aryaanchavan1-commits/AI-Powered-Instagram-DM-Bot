...
from aryan.login import login
from aryan.ai import gpt4o
from aryan.json_storage import JSONAuthorizationStorage
...
async def test(username, password,language,proxy,group_messages):
    ...
    # Initialize JSON authorization storage
    db = JSONAuthorizationStorage()
