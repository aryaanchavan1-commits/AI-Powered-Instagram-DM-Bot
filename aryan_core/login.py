...
class InstagramLogin:
    ...
    def login(self, username: str, password: str, verification_code=None, captcha_response=None, email_verification_code=None):
        """Login to Instagram with support for 2FA, captcha, and email verification"""
        ...
        if email_verification_code:
            data["verification_code"] = email_verification_code
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                if checkpoint_data and "email" in str(checkpoint_data).lower():
                    return {
                        "success": False,
                        "requires_email_verification": True,
                        "checkpoint_url": checkpoint_url,
                        "checkpoint_data": checkpoint_data,
                        "message": "Email verification required. Please check your email and enter the verification code."
                    }
    ...
    def verify_email(self, username, password, verification_code, checkpoint_url, checkpoint_data):
        ...
        try:
            ...
            if res.status_code == 200:
                ...
                return {
                    "success": False,
                    "message": f"Email verification failed: {response_data.get('message', 'Unknown error')}",
                    "response": response_data
                }
            ...
            return {
                "success": False,
                "message": f"Unexpected error during email verification: {str(e)}"
            }
...
def login(username: str, password: str, verification_code=None, proxy=None):
    """Legacy login function for backward compatibility"""
    login_handler = InstagramLogin(proxy=proxy)
